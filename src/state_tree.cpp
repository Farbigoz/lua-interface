...
extern LuaLib_Interface LUA_INTERFACE;


	StateTreeNode			stateTreeNode_trc3Gen_level = {
			.name = "level",
			.value = &LUA_INTERFACE.trc3Gen.level,
			.isUnsignedNum = true,
			.numSize = sizeof(LUA_INTERFACE.trc3Gen.level)};

	StateTreeNode			stateTreeNode_trc3Gen_carrier = {
			.name = "carrier",
			.value = &LUA_INTERFACE.trc3Gen.carrier,
			.isUnsignedNum = true,
			.numSize = sizeof(LUA_INTERFACE.trc3Gen.carrier)};

	StateTreeNode			stateTreeNode_trc3Gen_mod = {
			.name = "mod",
			.value = &LUA_INTERFACE.trc3Gen.mod,
			.isUnsignedNum = true,
			.numSize = sizeof(LUA_INTERFACE.trc3Gen.mod)};
...
StateTreeNode			stateTreeNode_trc3Gen = {
		...
		StateTreeNode			stateTreeNode_trc3Rec_1_level = {
				.name = "level",
				.value = &LUA_INTERFACE.trc3Rec.rec[0].level,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.trc3Rec.rec[0].level)};

		StateTreeNode			stateTreeNode_trc3Rec_1_carrier = {
				.name = "carrier",
				.value = &LUA_INTERFACE.trc3Rec.rec[0].carrier,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.trc3Rec.rec[0].carrier)};

		StateTreeNode			stateTreeNode_trc3Rec_1_mod = {
				.name = "mod",
				.value = &LUA_INTERFACE.trc3Rec.rec[0].mod,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.trc3Rec.rec[0].mod)};

		StateTreeNode			stateTreeNode_trc3Rec_1_tc = {
				.name = "tc",
				.value = &LUA_INTERFACE.trc3Rec.rec[0].tc,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.trc3Rec.rec[0].tc)};
	...
	StateTreeNode			stateTreeNode_trc3Rec_1 = {
		...
		StateTreeNode			stateTreeNode_trc3Rec_2_level = {
				.name = "level",
				.value = &LUA_INTERFACE.trc3Rec.rec[1].level,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.trc3Rec.rec[1].level)};

		StateTreeNode			stateTreeNode_trc3Rec_2_carrier = {
				.name = "carrier",
				.value = &LUA_INTERFACE.trc3Rec.rec[1].carrier,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.trc3Rec.rec[1].carrier)};

		StateTreeNode			stateTreeNode_trc3Rec_2_mod = {
				.name = "mod",
				.value = &LUA_INTERFACE.trc3Rec.rec[1].mod,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.trc3Rec.rec[1].mod)};

		StateTreeNode			stateTreeNode_trc3Rec_2_tc = {
				.name = "tc",
				.value = &LUA_INTERFACE.trc3Rec.rec[1].tc,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.trc3Rec.rec[1].tc)};
...
StateTreeNode			stateTreeNode_trc3Rec = {
		...
		StateTreeNode			stateTreeNode_arsGen_level_f75 = {
				.name = "f75",
				.value = &LUA_INTERFACE.arsGen.level.f75,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.level.f75)};

		StateTreeNode			stateTreeNode_arsGen_level_f125 = {
				.name = "f125",
				.value = &LUA_INTERFACE.arsGen.level.f125,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.level.f125)};

		StateTreeNode			stateTreeNode_arsGen_level_f175 = {
				.name = "f175",
				.value = &LUA_INTERFACE.arsGen.level.f175,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.level.f175)};

		StateTreeNode			stateTreeNode_arsGen_level_f225 = {
				.name = "f225",
				.value = &LUA_INTERFACE.arsGen.level.f225,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.level.f225)};

		StateTreeNode			stateTreeNode_arsGen_level_f275 = {
				.name = "f275",
				.value = &LUA_INTERFACE.arsGen.level.f275,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.level.f275)};

		StateTreeNode			stateTreeNode_arsGen_level_f325 = {
				.name = "f325",
				.value = &LUA_INTERFACE.arsGen.level.f325,
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.level.f325)};
	...
	StateTreeNode			stateTreeNode_arsGen_level = {
		...
		StateTreeNode			stateTreeNode_arsGen_gen1_f75 = {
				.name = "f75",
				.value = &LUA_INTERFACE.arsGen.gen1[F_075_HZ],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen1[F_075_HZ])};

		StateTreeNode			stateTreeNode_arsGen_gen1_f125 = {
				.name = "f125",
				.value = &LUA_INTERFACE.arsGen.gen1[F_125_HZ],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen1[F_125_HZ])};

		StateTreeNode			stateTreeNode_arsGen_gen1_f175 = {
				.name = "f175",
				.value = &LUA_INTERFACE.arsGen.gen1[F_175_HZ],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen1[F_175_HZ])};

		StateTreeNode			stateTreeNode_arsGen_gen1_f225 = {
				.name = "f225",
				.value = &LUA_INTERFACE.arsGen.gen1[F_225_HZ],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen1[F_225_HZ])};

		StateTreeNode			stateTreeNode_arsGen_gen1_f275 = {
				.name = "f275",
				.value = &LUA_INTERFACE.arsGen.gen1[F_275_HZ],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen1[F_275_HZ])};

		StateTreeNode			stateTreeNode_arsGen_gen1_f325 = {
				.name = "f325",
				.value = &LUA_INTERFACE.arsGen.gen1[F_325_HZ],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen1[F_325_HZ])};

		StateTreeNode			stateTreeNode_arsGen_gen1_f275_ao = {
				.name = "f275_ao",
				.value = &LUA_INTERFACE.arsGen.gen1[F_275_HZ_AO],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen1[F_275_HZ_AO])};
	...
	StateTreeNode			stateTreeNode_arsGen_gen1 = {
		...
		StateTreeNode			stateTreeNode_arsGen_gen2_f75 = {
				.name = "f75",
				.value = &LUA_INTERFACE.arsGen.gen2[F_075_HZ],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen2[F_075_HZ])};

		StateTreeNode			stateTreeNode_arsGen_gen2_f125 = {
				.name = "f125",
				.value = &LUA_INTERFACE.arsGen.gen2[F_125_HZ],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen2[F_125_HZ])};

		StateTreeNode			stateTreeNode_arsGen_gen2_f175 = {
				.name = "f175",
				.value = &LUA_INTERFACE.arsGen.gen2[F_175_HZ],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen2[F_175_HZ])};

		StateTreeNode			stateTreeNode_arsGen_gen2_f225 = {
				.name = "f225",
				.value = &LUA_INTERFACE.arsGen.gen2[F_225_HZ],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen2[F_225_HZ])};

		StateTreeNode			stateTreeNode_arsGen_gen2_f275 = {
				.name = "f275",
				.value = &LUA_INTERFACE.arsGen.gen2[F_275_HZ],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen2[F_275_HZ])};

		StateTreeNode			stateTreeNode_arsGen_gen2_f325 = {
				.name = "f325",
				.value = &LUA_INTERFACE.arsGen.gen2[F_325_HZ],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen2[F_325_HZ])};

		StateTreeNode			stateTreeNode_arsGen_gen2_f275_ao = {
				.name = "f275_ao",
				.value = &LUA_INTERFACE.arsGen.gen2[F_275_HZ_AO],
				.isUnsignedNum = true,
				.numSize = sizeof(LUA_INTERFACE.arsGen.gen2[F_275_HZ_AO])};
